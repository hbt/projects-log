...
- 2007: switching to linux (no longer needing windows for college work)
- 2008: beginning to store scripts, dotfiles, configuration and such under svn 
- 2012: migrating from svn to config and organizing scripts/dotfiles. Nothing is ever lost and everything configured properly.
...
In 2016, found out about [vcsh](https://github.com/RichiH/vcsh) which allows you to manage multiple git repositories.
