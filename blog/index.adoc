...
<li>
++++
link:project-metrics-32[project metrics]
++++
</li>

<li>deliberate practice resources for software engineers</li><ul></ul>
<li>accelerate software development cycle</li><ul></ul></ul>
<li>cliweb</li><ul>
