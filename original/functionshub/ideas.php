...
$t = [
    ...
    'support aws/gcloud functions to make it easier for users who dont know docker. keep docker for advanced stuff only. --- also increases nb functions',

    'make it part of the local network for users to reduce latency',
